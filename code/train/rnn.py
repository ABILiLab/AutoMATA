...
if __name__ == "__main__":
    ...
    # Single-layer RNN: Suitable for simple sequence modelling tasks with simple structure and high computational efficiency.
    # Multi-layer RNN: suitable for complex sequence modelling tasks, capable of capturing more complex patterns and long-range dependencies, but requires more computational resources.
    # Layer selection: needs to be determined through experiments, considering task complexity, data volume and computational resources.
    hidden_size = 32
    num_layers = 2 
    ...
    if (kfold):
        ...
        for i, (train_idx, val_idx) in enumerate(skf.split(X_train, Y_train)):
            ...
            # define model
            rnn = RNNModel(input_size, hidden_size, output_size, num_layers).to(device)
