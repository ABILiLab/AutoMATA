...
if __name__ == "__main__":
    """
    cmd: python predict_ladder.py
    output: ladder_prediction_results.png (visualize=1), ladder_prediction_results.json, ladder_prediction_results.txt
    ...
    parser.add_argument('--scaler_path', type=str, default='ladder_scaler.pkl', help='preprocessor file path')
